...
public class CreateIntersectingBoundsOp : BlueprintOperation
{
    public CreateIntersectingBoundsOp(MapGenerationContext context, BlueprintGenerator bpg, string boundsAInput, string boundsBInput)
        : base(context, bpg)
    {
