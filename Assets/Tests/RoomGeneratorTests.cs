...
namespace RyansLibrary.Labyrinth
{
    ...
    public class RoomGeneratorTests
    {
        ...
        public void TestParseUninitializedPath()
        {
            ...
            SetPrivateField(path, "_name", "Uninitialized Path");
        ...
        */
        ...
        // Rotation is passed explicitly; without it the call binds to the unique room overload, which skips these checks
        [Test]
        public void TestGenerateRoom()
        {
            ...
            // Act
            Room room = _generator.GenerateRoom(_path, _prefab1x1x1, o, RoomRotation.Deg0);
        ...
        public void TestGenerateMultiCellRoomClaimsAllBlueprints()
        {
            ...
            // Act
            Room room = _generator.GenerateRoom(_path, _prefab2x1x1, o, RoomRotation.Deg0);
        ...
        public void TestGenerateRoomNullPath()
        {
            ...
            // Act
            Assert.DoesNotThrow(() => room = _generator.GenerateRoom(null, _prefab1x1x1, o, RoomRotation.Deg0));
        ...
        public void TestGenerateRoomUninitializedPath()
        {
            ...
            // Act
            Assert.DoesNotThrow(() => room = _generator.GenerateRoom(path, _prefab1x1x1, o, RoomRotation.Deg0));
        ...
        public void TestGenerateRoomNullPrefab()
        {
            ...
            // Act
            Assert.DoesNotThrow(() => room = _generator.GenerateRoom(_path, null, o, RoomRotation.Deg0));
        ...
        public void TestGenerateRoomPrefabWithoutRoomComponent()
        {
            ...
            // Act
            Assert.DoesNotThrow(() => room = _generator.GenerateRoom(_path, prefab, o, RoomRotation.Deg0));
        ...
        public void TestGenerateRoomMissingBlueprintLeavesNoRoom()
        {
            ...
            // Act
            _generator.GenerateRoom(_path, _prefab2x1x1, o, RoomRotation.Deg0);
        ...
        public void TestGenerateRoomNoCells()
        {
            ...
            // Act
            Room room = _generator.GenerateRoom(_path, prefab, o, RoomRotation.Deg0);
        ...
        public void TestGenerateRoomNoContainer()
        {
            ...
            // Act
            Room room = generator.GenerateRoom(_path, _prefab1x1x1, o, RoomRotation.Deg0);
            if (room != null)
        ...
        /// <summary>
        /// The overload without a rotation spawns unique rooms. Their blueprints are already claimed when the room is
        /// placed, so it must spawn over claimed blueprints instead of refusing them like the parser path does.
        /// </summary>
        [Test]
        public void TestGenerateUniqueRoomOverClaimedBlueprint()
        {
            // Arrange
            Vector3Int o = RandomVector();
            Blueprint b1 = AddBlueprint(o, false);      // Claimed when the unique room was placed
        ...
        {
            Path path = Track(ScriptableObject.CreateInstance<Path>());
            SetPrivateField(path, "_name", "Test Path");
            path.Initialize();
            SetRoomShapes(path);
            return path;
        }
